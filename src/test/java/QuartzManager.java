...
public class QuartzManager {
	...
	public static void addJob(String jobName, Class<?> cls, String time ,String [] command) {
		try {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void modifyJobTime(String jobName, String time,String []command) {
		try {
			Scheduler sched = gSchedulerFactory.getScheduler();
			...
			if (!oldTime.equalsIgnoreCase(time)) {
				...
				removeJob(jobName);
				addJob(jobName, objJobClass, time, command);
			}
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
